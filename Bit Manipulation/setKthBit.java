/*
Q. Given a number N and a value K. From the right, set the Kth bit in the binary representation of N. The position of Least Significant Bit(or last bit) is 0, the second last bit is 1 and so on. 
...
Example 2:
    Input:
        ...
        K = 3
    Output: 15
    Explanation: The binary representation of the given
